# Newsmast Dashboard - Docker Installation Guide

This guide provides step-by-step instructions for installing Newsmast Dashboard using Docker containers.
...
2. You should see the Newsmast Dashboard login page
3. Login with the primary admin credentials you created

## Step 6: Activate the Dashboard
...
1. Login to your Newsmast Dashboard
...
**Congratulations!** Your Newsmast Dashboard should now be running successfully with Docker. You can now install additional plug-ins and customize your server through the dashboard interface.
