...
Follow the canonical [Patchwork Dashboard Docker procedure](https://github.com/patchwork-hub/patchwork_dashboard/blob/main/DOCKER_INSTALLATION.md) for exact commands, service names, health checks, migrations, logs, backups, and updates. The current Compose service is `app`.
