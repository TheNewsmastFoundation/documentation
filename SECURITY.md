...
A "vulnerability in Newsmast" is a vulnerability in the code distributed through one of our main source code repositories on GitHub. Vulnerabilities that are specific to a given installation (e.g. misconfiguration) should be reported to the owner of that installation and not us.
