...
For API authentication, role boundaries, and technical details, read the [administration reference](https://github.com/TheNewsmastFoundation/newsmast-dashboard/blob/main/docs/features/administration.md) and [Dashboard API reference](https://github.com/TheNewsmastFoundation/newsmast-dashboard/blob/main/docs/api/dashboard-api.md).