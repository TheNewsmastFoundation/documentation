...
> **Newsmast Dashboard boundary:** Ghost, WordPress, Firebase, CiviCRM, deep linking, and the integrations documented below **do not require** Newsmast Dashboard. Dashboard-owned Bluesky/DNS, Patchwork Hub, relay-operation, and storage workflows are documented separately in [Dashboard integrations](../newsmast-dashboard/features_integrations.md).
