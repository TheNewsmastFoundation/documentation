...
Use the [technical channels reference](https://github.com/patchwork-hub/patchwork_dashboard/blob/main/docs/features/channels.md) for endpoints, recovery/upgrade operations, and detailed permissions. See the related [Newsmast Mastodon custom-feeds guide](../newsmast-mastodon/features_custom_feeds.md).