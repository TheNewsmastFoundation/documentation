...
Read [configuration](configuration.md), the [technical settings reference](https://github.com/patchwork-hub/patchwork_dashboard/blob/main/docs/features/server-settings.md), and related [Newsmast Mastodon post features](../newsmast-mastodon/features_posts.md).