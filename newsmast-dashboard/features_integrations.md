...
Use [configuration](configuration.md) for operator setup and the [technical integrations reference](https://github.com/patchwork-hub/patchwork_dashboard/blob/main/docs/features/integrations.md) for verified dependencies and failure behavior.